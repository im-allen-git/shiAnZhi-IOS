			...
			FastClick.prototype.onTouchStart = function(event) {
				...
				if(deviceIsIOS) {
					...
					if(!deviceIsIOS4) {
						...
						// Weird things happen on iOS when an console.log or confirm dialog is opened from a click event callback (issue #23):
						// when the user next taps anywhere else on the page, new touchstart and touchend events are dispatched
						// with the same identifier as the touch event that previously triggered the click that triggered the console.log.
